    ...
    <>
      ...
      <Dialog open={showStopConfirmDialog} onOpenChange={setShowStopConfirmDialog}>
        <DialogContent className={cn(
          ...
          "dark:bg-[#1a1a2e] dark:border-[#2a2a3e]",
          "dark:shadow-[0_0_40px_rgba(251,146,60,0.15)]",
          "light:bg-white light:border-orange-200",
          "light:shadow-xl"
        )}>
          <DialogHeader>
            <DialogTitle className={cn(
            ...
            <DialogDescription className={cn(
              "dark:text-gray-400 light:text-gray-600 space-y-2"
            )}>
              <p>Are you sure you want to stop the recurrence for <span className="font-semibold dark:text-white light:text-gray-900">&quot;{task.title}&quot;</span>?</p>
              <p className="text-sm">This task will no longer repeat automatically. You can still complete or delete this instance.</p>
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            <Button
              ...
              className={cn(
                ...
                "dark:hover:bg-[#2a2a3e] dark:hover:border-orange-500/40",
                "light:bg-white light:border-gray-200 light:text-gray-900",
                "light:hover:bg-gray-50 light:hover:border-orange-400"
              )}
            >
              Cancel
            </Button>
            ...
            <Button
              ...
              className={cn(
                ...
                "dark:bg-orange-600 dark:hover:bg-orange-700 dark:shadow-orange-600/20",
                "light:bg-orange-600 light:hover:bg-orange-700 light:shadow-orange-600/20"
              )}
            >
              {isStopping ? (
                <>
