...
def _create_async_engine():
    ...
    if DATABASE_URL.startswith("sqlite://"):
        ...
        # Use moderate pool settings for serverless PostgreSQL with streaming
        # Note: asyncpg uses ssl='require' instead of sslmode='require'
        return create_async_engine(
            async_database_url,
            pool_size=5,              # Allow 5 concurrent connections for streaming
            ...
            connect_args={"ssl": "require", "timeout": 60},  # asyncpg uses ssl='require', 60s query timeout
        )
