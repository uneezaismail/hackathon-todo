...
class TaskCreate(BaseModel):
    ...
    # Phase V: RRULE-based recurring fields
    recurring_pattern: Optional[str] = Field(
        default=None,
        max_length=500,
        description="RRULE pattern string (e.g., DAILY, WEEKLY, FREQ=DAILY;INTERVAL=2)",
        examples=["DAILY", "WEEKLY", "FREQ=WEEKLY;BYDAY=MO,WE,FR"]
    )
