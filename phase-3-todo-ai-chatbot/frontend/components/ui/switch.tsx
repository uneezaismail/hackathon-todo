...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "dark:focus-visible:ring-offset-[#0A0A1F] light:focus-visible:ring-offset-white",
      "disabled:cursor-not-allowed disabled:opacity-50",
      // Checked state - purple
      "data-[state=checked]:dark:bg-purple-500 data-[state=checked]:light:bg-purple-600",
      // Unchecked state
      "data-[state=unchecked]:dark:bg-gray-700 data-[state=unchecked]:light:bg-gray-300",
      className
    )}
    {...props}
    ref={ref}
