...
echo "=================================================="
echo ""
echo "🌐 Access Application from Windows Browser (WSL2):"
echo ""
echo "   Run these in separate terminal windows (KEEP THEM OPEN):"
echo ""
echo "   1. Frontend (localhost:3000):"
echo "      kubectl port-forward svc/todo-app-frontend 3000:3000 -n todo-app"
echo ""
echo "   2. Backend (localhost:8000):"
echo "      kubectl port-forward svc/todo-app-backend 8000:8000 -n todo-app"
echo ""
echo "   Once forwarding is running access:"
echo "   - Frontend: http://localhost:3000"
echo "   - Backend Docs: http://localhost:8000/docs"
echo ""
echo "   Alternative (Linux/Mac):"
echo "   Frontend: http://$(minikube ip):30300"
echo "   Backend:  http://$(minikube ip):30301"
echo ""
...
log_success "Deployment automation complete!"s